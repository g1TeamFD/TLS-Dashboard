...
const MEMBER_AVATARS = {
  ...
  ANGUMA: avatarImage("1GtBWA3Ppwfd0hiRCgOKBUYu6Mxg8M6IK"),
  BEN: avatarImage("1FpGH1pilVs4--sAaq5a5o-e8sGzxl8H1"),
  BIMBIM: avatarImage("1Xn6Xqd9MRBzlY8rl-rKqQ5YcsxilXzB3"),
  BILL: avatarImage("1M_OSYfryZ6QU1619tWNNVIcUENFhfAKB"),
  BLCOP: avatarImage("119AIrYvQpXRXUJW599YszqxoyoA2BaNv"),
  CHERRY: avatarImage("1dko_tF741E00khxIet9r5WW14NaCfIH6"),
  CHILLI: avatarImage("1WBqAKkaT-VIrNu5Dvbpia25EOYdVPIuz"),
  DALEM: avatarImage("11n9R-bdPelV7WAr_hWqrLwIsOJAw3GXi"),
  DIEPMINH: avatarImage("1PhZfhkEP7r8xVRHLh7vuHZEC2--_T1nF"),
  DUCMINH: avatarImage("1NxS_XdWcBgDqkqal4LvzcydvF_nQQNV_"),
  DUCTHINH: avatarImage("1FHtkYorWR3SH1-aOJMQqwEVKJhcRyAJo"),
  ELA: avatarImage("1Bk-0_U67uyE5ifA382jzBRd2ZCl6iOf7"),
  ELF: avatarImage("1cyc39zvDSKQpmnZi06odJ4Hq5rJqTYMS"),
  ELF001: avatarImage("1cyc39zvDSKQpmnZi06odJ4Hq5rJqTYMS"),
  ELSA: avatarImage("1pWXanscVEjk1BvyBkMqwJ6G9zFLLxNVC"),
  GIABAO: avatarImage("1k8yu0TOXwfA5chSlLFjAWwMpdXtgNt6H"),
  GIANI: avatarImage("1cujcVpjVXQQvZ3jV8ps0dGKtWa2xZtls"),
  HAIDANG: avatarImage("1pjmevoKw8fufCEE-C2U3nqH0lcKwSJN-"),
  HALIMA: avatarImage("1ngXwl05R9-BX__nk0CUqVOYAfIzHuXih"),
  HANA: avatarImage("1Z1ADEsh8hc1QTiMMiCUPEpYKxguRsRYz"),
  INTAN: avatarImage("1m4Y6Jjcokz6aejHKPIid0AU3mMaDym2Q"),
  JACOB: avatarImage("1UbaguDiyoMz1IyS_mUU63Mt4h7YOOLeK"),
  JAYDEN: avatarImage("1Awb-6I9PSH1hbYrAfwHr2NKIFG2gfh3q"),
  JFP: avatarImage("1snPxTyqmNwKxVQhUKOUzNhCG1-zOwK-N"),
  JIMMY: avatarImage("1AFHUhpbTM_-CR94J7Hz-i3tLgv7LwFt1"),
  KATE: avatarImage("1GsulWe2QM4GIwHB62Y4y0So1JaTArdSk"),
  KAYOBI: avatarImage("1VGb-2wopuDYovOV6XYwrep6hAtcwzOUT"),
  KYLA: avatarImage("1LG9raPaGo-oRw6S9e24OIwrcskjKSjDI"),
  LEONITA: avatarImage("1f_Bj3TW50ZiT41IiELhNkD5M1ELxphe-"),
  LINHANH: avatarImage("176NPHiwsMSR8N6GW8T84pss0w5m5P9ep"),
  LUNA: avatarImage("1diq02p5N40zcjm9p4LFC1jtsp3QOrXtS"),
  MIKE: avatarImage("1mxo7RvGoU471s0kCbj7-zO_6-dQviAad"),
  NHATLINH: avatarImage("1yHuO-6zXGWSssnGgKqwu8bAdUhwc27sU"),
  NHATMINH: avatarImage("1s_qzp7t3-gXq1WSDnHDRI2PJ1rHsXzDh"),
  RATNA: avatarImage("1Td9Z9_2lhto08iQ5lxILcuOQva52bNPH"),
  SEKAR: avatarImage("1iitm68XmWLL-g1bB-TyFP5f8ll95BqbN"),
  THIENBAO: avatarImage("10BTxnJQxrAvmLrza06rUJRfKpaGy9Der"),
  TUEAN: avatarImage("16qbdTRNZaouPA_DEkmaisB2LCCSmM6Un"),
  WIATI: avatarImage("1baLkoHg5P9L3k7J5u16pB8uA64oeVD1K"),
  WIHEL: avatarImage("13sfLYIRbk5jz4R5gDK3smlr0nRpGxWEL"),
  WYBIE: avatarImage("14HxYGHSw_-VJ6sjTt1IbMbS2pU493-dz"),
  ZAVA: avatarImage("1UniWJ8QV84KzP0LgSWlprquEpD77yhoz"),
};
